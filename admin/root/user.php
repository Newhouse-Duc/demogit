                    ...
                    <div class="table-title">
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <button style="margin-right: 20px;" type="button" class="btn btn-info add-new"><a style="font-size: 15px;color: white;" href="add_user.php">ADD</a></button>
                            </div>
                        </div>
                    </div>
                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                "><?php echo $value['email'] ?></td>
                                    ...
                                    <td>
                                        <a class="edit" title="Edit" name="edit" href="edit_user.php?id=<?php echo $value['id']  ?>"><i class="material-icons">&#xE254;</i></a>
